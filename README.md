...
| Hosted demo and broader device testing | Current town release deployed; home/sample, locally imported town, real Privy login and successful Sepolia transfer checked online. Broader device coverage needs verification. |
