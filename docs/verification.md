...
- Public homepage delivery and the earlier competition video URLs were verified as recorded above. The optional Privy extension's deployed configuration, authenticated wallet behavior and receipt flow remain unverified; successful static HTTP delivery does not establish those functions.
