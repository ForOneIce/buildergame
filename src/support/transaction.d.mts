...
export interface DonationState { phase: DonationPhase; intent: DonationIntent | null; estimate: DonationEstimate | null; hash: string | null; error: string | null }
...
export function createDonationFlow(options?: { onConfirmed?: (projectId: string, result: { hash: string; amount: string; recipient: string }) => void; persist?: (checkpoint: DonationCheckpoint | null) => void; timeoutMs?: number; receiptWaitMs?: number; pollMs?: number }): DonationFlow;
